...
struct usb_device_id rtusb_usb_id[] = {
	...
	{USB_DEVICE(0x07D1,0x3C0D)}, /* D-Link DWA-125 H/W Ver.: A1 (1T1R) */
	{USB_DEVICE(0x07D1,0x3C16)}, /* D-Link DWA-125 H/W Ver.: A2 (1T1R) */
	...
	{USB_DEVICE(0x0B05,0x1784)}, /* Asus USB-N13 ver. 1.10 */
#endif // RT3070 //
	{ }/* Terminating entry */
};
