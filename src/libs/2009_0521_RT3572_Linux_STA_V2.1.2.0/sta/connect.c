...
/* No need to perform this routine when ATE is running. */
...

	{
		...
		else
		{
			...
			{
				pAd->StaCfg.GroupCipher = pAd->ScanTab.BssEntry[BssIdx].WAPI.GroupCipher;
				pAd->StaCfg.PairCipher = pAd->ScanTab.BssEntry[BssIdx].WAPI.PairCipher;									
			}
#endif // WAPI_SUPPORT //
	...
	IN  BOOLEAN      IsReqFromAP)
{
	...
	{		
		...
		NdisZeroMemory(pAd->StaCfg.rx_iv, LEN_TX_IV);
	...
	IN PRTMP_ADAPTER pAd) 
{
	...
	if (BssIdx < pAd->MlmeAux.SsidBssTab.BssNr) 
	{
		...
		{
			pAd->StaCfg.GroupCipher = pAd->MlmeAux.SsidBssTab.BssEntry[BssIdx].WAPI.GroupCipher;
			pAd->StaCfg.PairCipher = pAd->MlmeAux.SsidBssTab.BssEntry[BssIdx].WAPI.PairCipher;						
		}
#endif // WAPI_SUPPORT //
