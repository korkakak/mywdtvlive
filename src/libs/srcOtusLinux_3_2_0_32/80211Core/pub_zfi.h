...
extern void zfiWlanSetMonitorEnable(zdev_t* dev, u8_t monitorEnable);
extern void zfiWlanSetNewAPSlectiAlogrithm(zdev_t* dev, u8_t NewAPSelAlog);


extern u8_t* zfiGetAsocReqFrameBody(zdev_t* dev, u16_t* pAsocReqFrameBodySize);
extern u8_t* zfiGetAsocRspFrameBody(zdev_t* dev, u16_t* pAsocRspFrameBodySize);
extern u8_t* zfiGetBeaconFrameBody(zdev_t* dev, u16_t* pBeaconFrameBodySize);
...
extern void zfiWlanBackupACUSSID(zdev_t* dev, u8_t* ssid, u8_t ssidLength,u8_t* ssid2, u8_t ssid2Length,u8_t* ssid3, u8_t ssid3Length);
extern void zfiWlanBackupPrefBssid(zdev_t* dev, u8_t* prefBssid1, u8_t* prefBssid2, u8_t* prefBssid3, u8_t* prefBssid4);
...
extern u8_t zfiWlanQuerywmeInfo(zdev_t* dev);
...
extern const unsigned char* zfiWlanQueryCountryIsoName(zdev_t* dev);
...
extern void zfiWlanSetIBSSHTAndAggrEnable(zdev_t* dev, u8_t htAdhoc, u8_t htAdhocHT40, u8_t htAdhocAggr);
extern void zfiWlanSetLedControl(zdev_t*dev, u32_t support, u16_t LedOnTime, u16_t LedOffTime);
extern void zfiWlanQueryLedControl(zdev_t* dev, u32_t* support, u16_t* Ton, u16_t* Toff);
extern void zfiWlanSetAdditionalAssocIE(zdev_t* dev, u32_t additionalAssocIESize, u8_t* additionalAssocIE);
...
extern u32_t zfiResetToBootCode(zdev_t* dev);
