...
u16_t zfTxGenWlanHeader(zdev_t* dev, zbuf_t* buf, u16_t* header, u16_t seq,
                        ...
                        u16_t* da, u16_t* sa, u8_t up, u16_t* mic, u16_t *micLen,
...
void zfTKIPEncrypt(zdev_t *dev, zbuf_t *buf, u8_t *snap, u16_t snapLen, u16_t* mic, u16_t* micLen, u16_t offset, u8_t keyLen, u8_t* key, u32_t* icv);
...
void zfWEPEncrypt(zdev_t *dev, zbuf_t *buf, u8_t *snap, u16_t snapLen, u16_t* mic, u16_t* micLen, u16_t offset, u8_t keyLen, u8_t* WepKey, u8_t *iv);
